...
public class UserInfo implements Serializable {
  ...
  public static UserInfo fromJson(String json) {
    return WechatGsonBuilder.INSTANCE.create().fromJson(json, UserInfo.class);
  }

  public static List<UserInfo> fromJsonList(String json) {
    Type collectionType = new TypeToken<List<UserInfo>>() {
    }.getType();
    Gson gson = WechatGsonBuilder.INSTANCE.create();
